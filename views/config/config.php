...
<div class="panel panel-default">
    <div class="panel-heading"><?php echo Yii::t('RecentSpacesModule.base', 'Recent Spaces Module Configuration'); ?></div>
    <div class="panel-body">
        ...
        <a class="btn btn-default" href="<?php echo $this->createUrl('//admin/module'); ?>"><?php echo Yii::t('RecentSpacesModule.base', 'Back to modules'); ?></a>
